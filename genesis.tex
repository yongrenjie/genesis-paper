...
If necessary, it is still possible to specify the \texttt{USERPx} parameters; these will override the AU programmes parsed from the pulse programme, allowing for customised processing.
